...
/**
 * Map auction house names to their logo slugs
 * This handles special cases where the name doesn't slugify cleanly
 * 
 * @param string $name Auction house name
 * @return string Logo slug
 */
function getAuctionLogoSlug($name) {
    $nameMappings = [
        'Aucor Auctioneers' => 'aucor-auctioneers',
        'Aucor Auctioneers Bloemfontein' => 'aucor-auctioneers',
        'Bidders Choice' => 'bidders-choice',
        'High Street Auctions' => 'high-street-auctions',
        'Prime Auctions' => 'prime-auctions',
        'Auction Nation' => 'auction-nation',
        'Auction Nation Cape Town' => 'auction-nation',
        'SA Auction Group' => 'sa-auction-group',
        'SA Group' => 'sa-auction-group',
        'Claremart Auctioneers' => 'claremart-auctioneers',
        "Van's Auctioneers" => 'vans-auctioneers',
        'Park Village Auctions' => 'auction-nation',
        'WH Auctioneers' => 'wh-auctioneers',
        'Auction Operation' => 'auction-operation',
        'GoBid' => 'gobid',
        'Johannesburg Auctioneers' => 'johannesburg-auctioneers',
        'Old Johannesburg Warehouse Auctioneers' => 'old-johanessburg-warehouse-auctioneers',
        'Marietjie Keet Auctioneers' => 'marietjie-keet-auctioneers',
        'Cahi Auctioneers' => 'cahi-auctioneers',
        'Strauss & Co Fine Art Auctioneers' => 'strauss-&-co-fine-arts-auctioneers',
        'Nuco Auctioneers' => 'nuco-auctioneers',
        'Grand Oak Auctions' => 'grand-oak-auctions',
        'Traveling Auctioneers SA' => 'traveling-auctioneers-sa',
        'Bernardi Auctioneers' => 'bernadi-auctioneers',
        'AuctionInc' => 'auctioninc',
        'Cape Auctioneers' => 'cape-auctioneers',
        'WCT Auctions' => 'wct-auctions',
        'Ambassador Auctioneers' => 'ambassador-auction',
        'Westgate Walding Auctions' => 'westgate-walding-auctions',
        'Stephan Welz & Co' => 'stephen-welz-&-co'
    ];
    ...
    foreach ($nameMappings as $key => $slug) {
...
/**
 * Get the logo path for an auction house
 * Uses the mapping for proper slug resolution
 * 
 * @param string $name Auction house name
 * @return string Logo path or default fallback
 */
function getAuctionLogo($name) {
    // Get the mapped slug
    $slug = getAuctionLogoSlug($name);
    
    $path = "/assets/logos/{$slug}.png";
    
    // Check multiple possible paths for development/testing
    $possiblePaths = [
        // Absolute path for this project
        '/workspaces/auction-atlas-/auction-atlas-new/assets/logos/' . $slug . '.png',
        // Relative from auction-atlas-new/
        dirname(__FILE__, 2) . '/assets/logos/' . $slug . '.png',
        // Current working directory relative
        getcwd() . '/auction-atlas-new/assets/logos/' . $slug . '.png'
    ];
