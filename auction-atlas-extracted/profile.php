            ...
            <div class="flex-1">
                <div class="flex items-center gap-3 mb-2">
                    <div class="flex items-center gap-4">
                        <img src="<?php echo getLogo($auction['name']); ?>" alt="<?php echo e($auction['name']); ?>" class="w-16 h-16 sm:w-20 sm:h-20 object-contain rounded-xl bg-white border-2 border-white/20">
